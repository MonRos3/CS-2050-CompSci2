 ...
 * Professor Blanche
 *
 * This program converts infix notation to postfix notation using a linked list.
 ***/
import java.io.*;
...
public class Program4 {
    ...
    public static void main(String[] args) {
        try {
            BufferedReader inputFile = new BufferedReader(new FileReader("Program4.txt"));
            BufferedWriter outputFile = new BufferedWriter(new FileWriter("Program4.out"));
            String line;
